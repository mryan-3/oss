        ...
        <section className='mx-4 flex flex-col gap-20 pb-14 pt-16 md:px-10 md:py-24 lg:flex-row lg:gap-2.5 lg:px-16 xl:px-20 2xl:px-52 '>
            <div className='relative z-10 flex h-full flex-1 flex-col items-start justify-center md:mx-auto md:items-center lg:items-start lg:text-center'>
                <header className='mx-auto  flex w-full flex-col justify-center md:items-center md:text-center lg:mx-0 lg:items-start lg:text-start'>
                    <p className='mx-auto mb-8 w-fit rounded-full border border-black bg-[#88aaee] px-3 text-black py-1 text-sm font-medium shadow-md md:mx-0 md:mb-2 md:shadow-none'>
                        Zenetra OSS
                    </p>
                    <h1 className='scroll-m-20 text-center text-4xl font-extrabold tracking-tight md:text-5xl mt-2 text-black lg:text-start lg:text-6xl'>
                ...
                <div className='mx-auto mt-8 flex justify-start md:mx-0'>
                    <Link
                        href='/#contact-us'
                        className={
                            'text-lg border-2 border-black py-2 px-6 bg-[#88aaee] hover:opacity-90 text-black active:opacity-100 hover:border-1'
                        }
                    >
                        See our projects
                    </Link>
            ...
            <div className='max-w-xm h-full flex-1 border-2 border-black'>
...
function Projects() {
    return (
        <section className='mx-4 flex flex-col gap-20 md:px-10 pb-32 lg:gap-2.5 lg:px-16 xl:px-20 2xl:px-52 '>
            <h2 className='text-2xl font-semibold tracking-tight md:text-4xl mt-2 text-black lg:text-start'>
                Our Projects
            </h2>
            ...
            <div className='grid mt-6 grid-cols-1 md:grid-cols-3 2xl:grid-cols-4'>
                {OSSProjects.map((project, index) => (
                    <Link
                        href={project.link}
                        key={'projects_' + index}
                        className='flex divide-y flex-col gap-4 border-2 hover:opacity-80 border-black bg-white'
                    >
                        <div className='p-4'>
                            <Image
                                src={project.image}
