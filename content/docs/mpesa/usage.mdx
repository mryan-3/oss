---
title: Using the SDK
description: Using the SDK is simple and straightforward. Get it working in minutes!
---

### Initialize the SDK
Use the `Mpesa` class to initialize the SDK with your credentials. You SHOULD store your credentials in a `.env` file and use `dotenv` to load them into your application.
